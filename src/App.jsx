...
export default function RootApp() {
  ...
  const [lockSigner, setLockSigner] = useState(false); // verrouillage UI si auto
  const [loading, setLoading] = useState(false);
  ...
  useEffect(() => {
    return onAuthStateChanged(auth, async (u) => {
      ...
      if (u) {
        ...
        // Auto-sélection du signataire selon l'email connecté
  ...
  const generateReceipt = async () => {
    ...
    // priorité au mapping par e-mail si dispo
    ...
    try {
      ...
      // Sauvegarde Firestore (trace du reçu)
      try {
      ...
      await addDoc(collection(db, "mail"), {
        ...
        bcc: [MAIL_ARCHIVE_BCC],        // copie cachée
        from: MAIL_FROM,                // expéditeur no-reply
...
L’équipe de l’Association MIM`,
        ...
        // PJ au NIVEAU RACINE (format conforme à ton envoi réussi)
        attachments: [
          {
            filename: fileName,
      ...
      // (on ne reset pas date/mode pour aller plus vite)
          ...
          <div className="form">
            ...
            <div>
              ...
              <select
                ...
                disabled={lockSigner} // grisé si email mappé
              >
